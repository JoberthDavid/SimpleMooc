...
SECRET_KEY = '2bozmh*!dm02hp(g+t&=n!h&0$w6%787uw$yfi0x*19a*6qf-2'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'simplemooc', 'media') #essa variável salva o caminho para as imagens de upload que o usuário fizer
MEDIA_URL = '/media/'
#Alterações no auth
LOGIN_URL = 'login' 
